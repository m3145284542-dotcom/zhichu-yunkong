"""Layout-only production; never writes upstream scientific artifacts."""
...
ROOT=HERE.parents[1]
SOURCE=ROOT/'reports/phase13_5/technical_report_final.md'
EXPECTED='9bf8dfa229202aa4719537136a5cf74c80f11f300fe087528d626adf159754bf'
...
while i<len(lines):
    ...
    if l.startswith('!['):
        ...
        if 'sci_04_' in img.name:imgpath='assets/figure_04_layout.png'
        j=i+1
